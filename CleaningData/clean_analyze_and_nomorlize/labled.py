...
XRAY_MAPPING = {
    'CHEST': [
        'CHEST', 'THORAX', 'LUNG', 'RIB', 'CLAVICLE', 'HEST', 'CNEST', 'PHOI', 'GHEST', 
        'CHIEST', 'CFIEST' # New: CHIESTPA, CFIESTPA
    ],
    'SKULL': [
        'SKULL', 'HEAD', 'SINUS', 'MANDIBLE', 'ZYGOMA', 'NASAL', 'FACE', 'SO', 'HAM',
        'SYULL', 'SXULL' # New: SYULLAP, SXULLAP
    ],
    'SPINE': [
        'SPINE', 'CERVICAL', 'LUMBAR', 'THORACIC', 'SACRUM', 'COCCYX', 'NECK', 'COT SONG', 
        'L-SPINE', 'C-SPINE', 'T-SPINE', 'LSPINE', 'CSPINE', 
        'SFINE' # New: L-SFINEAP
    ],
    'ABDOMEN': ['ABDOMEN', 'ABD', 'KUB', 'BUNG'],
    'PELVIS': [
        'PELVIS', 'HIP', 'SI JOINT', 'CHAU', 
        'HIIP', 'ELVIS' # New: HIIPBOTHIAP (Hip), ELVISAP (Pelvis mất chữ P)
    ],
    'KNEE': [
        'KNEE', 'PATELLA', 'GOI', 
        'YNEE', 'NEEF', 'KEER' # New: YNEERAP, NEEFAP, KEERAP
    ],
    'SHOULDER': [
        'SHOULDER', 'SCAPULA', 'VAI', 
        'SHOULDE', 'SHJOULDE' # New: SHOULDEFFAP (OCR đọc sai chữ R thành F)
    ],
    'HAND': [
        'HAND', 'FINGER', 'THUMB', 'DIGIT', 'BAN TAY', 'NGON TAY', 
        'HIAND', 'FINGEP' # New: HIANDLAP (Cứu được 120 ảnh!), FINGEP
    ],
    'WRIST': [
        'WRIST', 'CARPAL', 'CO TAY', 
        'WPIST', 'WVPIST', 'WVRIST' # New: WPIST (OCR đọc sai R thành P)
    ],
    'ELBOW': ['ELBOW', 'KHUYU'],
    'FOREARM': [
        'FOREARM', 'RADIUS', 'ULNA', 'CANG TAY', 
        'FOFE', 'FOREAF' # New: FOFEAPMLAP, FOREAFMRAP
    ],
    'FOOT': [
        'FOOT', 'TOE', 'HEEL', 'CALCANEUS', 'BAN CHAN', 
        'TOFF' # New: TOFFAP (Toe)
    ],
    'ANKLE': [
        'ANKLE', 'CO CHAN', 
        'ANYLE', 'ANXLE', 'ANIKLE' # New: ANYLE, ANXLE (K đọc thành Y hoặc X)
    ],
    'HUMERUS': [
        'HUMERUS', 'ARM', 'CANH TAY', 
        'HUMEPUS' # New: HUMEPUSRAP
    ],
    'FEMUR': ['FEMUR', 'THIGH', 'DUI'],
    'LEG': ['LEG', 'TIBIA', 'FIBULA', 'CANG CHAN']
}
